...
class UserController{
    ...
    async updateProductRating(req,res,next){
        ...
        try{
            ...
            const productUpdated = await models.Product.update({...product},{where:{id:product.id}}); // делаем запрос на обновление объекта товара в базе данных,где поле id равно значению поля product.id,который мы взяли из тела запроса,обновляем все поля объекта товара
