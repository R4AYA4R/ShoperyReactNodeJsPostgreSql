...
class UserController{
    ...
    async getAllProductsBasket(req,res,next){
        ...
        try{
            ...
            const productsBasket = await models.BasketProduct.findAll({where:{userId}}) // получем все объекты товаров корзины у которых поле userId равно параметру userId который мы взяли из query параметров url(строки) запроса
